describe "#oxford_comma" do
  ...
  it "correctly formats arrays of lengths greater than three" do
    ...
    expect(oxford_comma(["kiwi", "durian", "starfruit", "mangos", "dragon fruits", "lychees", "pomelos"])).to eq("kiwi, durian, starfruit, mangos, dragon fruits, lychees, and pomelos").join("")
  end
end
